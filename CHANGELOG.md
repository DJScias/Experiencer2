...
## [6.5.4] - 2026-03-07
First proper Midnight release, addressing a bug with showing reputations as "Paragon".  

### Fixed  
- Fix Midnight reputations showing "Paragon" when they were not [#25](https://github.com/DJScias/Experiencer2/issues/25)).  
